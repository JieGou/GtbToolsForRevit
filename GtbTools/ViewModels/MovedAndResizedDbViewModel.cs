...
{
    public class MovedAndResizedDbViewModel : INotifyPropertyChanged
    {
        ...
        private MovedAndResizedDbViewModel()
        {

        }

        public static MovedAndResizedDbViewModel Initialize(DurchbruchModel durchbruchModel)
        {
            MovedAndResizedDbViewModel result = new MovedAndResizedDbViewModel();
